...
class GolfCourseMaster extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['total_reviews', 'average_rating', 'CurrencyISO', 'rakActive', 'meta_title', 'meta_description', 'meta_keywords', 'TieUp', 'ClosedDays', 'ContactPerson', 'PaymentMode', 'ContractValidFrom', 'ContractValidTill', 'YearStarted', 'Designer', 'PriceIncludes', 'CourseType', 'CreatedOn'], 'required'],
            ...
            [['ContractValidFrom', 'ContractValidTill', 'YearStarted', 'CreatedOn'], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'isIsosAxisActive' => 'Is Isos Axis Active',
