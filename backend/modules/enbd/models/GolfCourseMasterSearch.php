...
use backend\modules\enbd\models\GolfCourseMaster;

/**
 * GolfCourseMasterSearch represents the model behind the search form of `backend\modules\enbd\models\GolfCourseMaster`.
 */
